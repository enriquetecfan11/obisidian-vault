...
## Versión y imagen Docker

```bash
# Imagen recomendada
evoapicloud/evolution-api:v2.3.6

# Variable crítica de sesión
...
DATABASE_CONNECTION_URI=postgres://postgres:780d320181142a4b49f2@$(PROJECT_NAME)_evolution-api-db:5432/$(PROJECT_NAME)
...
# RabbitMQ (desactivado por defecto)
...
CACHE_REDIS_URI=redis://default:d6fc88e1b8f592f93eca@$(PROJECT_NAME)_evolution-api-redis:6379
